...
set CLASSPATH=%APP_HOME%\lib\madrid-0.1-all.jar

@rem Execute madrid
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MADRID_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MADRID_EXIT_CONSOLE%" exit 1
exit /b 1
